...
bool encrypt( const buffer_ptr_t& plain, buffer_ptr_t& cipher)
{
	...
	//switch( config.crypt() )
	//{
	//case ns::crypt_type_aes: return encrypt_aes_buffer( config.crypt_key(), config.crypt_iv(), plain, cipher);
	//	break;
	//case ns::crypt_type_arc4:return decrypt_arc4_buffer( config.crypt_key(), cipher, cipher );
	//	break;
	//case ns::crypt_type_plain:
